...
output "public_subnet_network_security_group_association_id" {
  description = "ID of the public subnet network security group association (null when workspace subnets are not created)"
  value       = var.workspace_subnets.create ? azurerm_subnet_network_security_group_association.workspace_subnets["host"].id : null
}

output "private_subnet_network_security_group_association_id" {
  description = "ID of the private subnet network security group association (null when workspace subnets are not created)"
  value       = var.workspace_subnets.create ? azurerm_subnet_network_security_group_association.workspace_subnets["container"].id : null
}

output "network_configuration" {
  description = "Network configuration for use with the workspace module (null when workspace subnets are not created, e.g. hub VNet)"
  value = var.workspace_subnets.create ? {
